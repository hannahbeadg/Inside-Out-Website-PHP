...
<html>
<head>
    <title>Inside Out Admin Watch</title>
...
<div>
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-top">
            ...
            <a href="adminwatch.php" style="background:#1f2937; color:white;">
    ...
    <div class="main">
        ...
        <div class="card card-box p-3">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <div>
                    <a href="watch_add.php" class="btn btn-primary btn-sm">
            ...
            <table class="table table-hover table-bordered align-middle">
                ...
                <tbody class="text-center">
                    ...
                    <?php
                        $query = mysqli_query(
                            $conn,
                            "SELECT * FROM tbl_watch ORDER BY display_order ASC"
                        );
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo $row['watchbutton_link']; ?>" target="_blank">
                                Open Link
                            </a>
                        </td>
                        ...
                        <td>
                            ...
                            <a href="edit_watch.php?id=<?php echo $row['watch_id']; ?>"
                               class="btn btn-primary btn-sm mb-1">
                                Edit
                            </a>

                            <a href="deletewatch.php?id=<?php echo $row['watch_id']; ?>"
